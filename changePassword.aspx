        ...
        <div class="left">
            <div class="form-container">
                ...
                <form id="forgetPasswordForm" runat="server">
                    ...
                    <asp:RequiredFieldValidator ID="rfvNewPass" runat="server" ControlToValidate="newPass" ErrorMessage="New password is required" CssClass="error-message" Display="Dynamic"></asp:RequiredFieldValidator>
                    ...
                    <asp:RequiredFieldValidator ID="rfvReNewPass" runat="server" ControlToValidate="reNewPass" ErrorMessage="Please confirm your password" CssClass="error-message" Display="Dynamic"></asp:RequiredFieldValidator>
                    <asp:CompareValidator ID="cvPassword" runat="server" ControlToValidate="reNewPass" ControlToCompare="newPass" ErrorMessage="Passwords do not match" CssClass="error-message" Display="Dynamic"></asp:CompareValidator>

                    <asp:Button ID="btnSPass" runat="server" Text="Submit" OnClick="btnSPass_Click" />
                </form>
            </div>
        </div>
        <div class="right" style="background: url('Image/changePass.jpeg') no-repeat; background-size: cover;"></div>
    </div>
</body>
<script>
